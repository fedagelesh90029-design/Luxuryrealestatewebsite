  ...
  const services = [
    {
      ...
      description: 'Возведение надежных монолитных конструкций и стен с учетом сейсмической активности региона',
    },
    {
      icon: Ruler,
      title: 'Инженерные системы',
      description: 'Проектирование и монтаж современных сетей водоснабжения, отопления и электрики',
    },
    {
      icon: Users,
      title: 'Фасадные и кровельные работы',
      description: 'Премиальная отделка фасадов и устройство надежных кровельных систем любой сложности',
    },
    {
      icon: Award,
      title: 'Технический надзор',
      description: 'Строгий контроль качества на каждом этапе и полная прозрачность всех строительных процессов',
    },
  ];
